...
#ifndef _PLATFORM_ZEPHYR_H_
#define _PLATFORM_ZEPHYR_H_
#pragma once
...
/**
* VL53L4CD device instance for Zephyr.
*/
...
/**
 * @brief Initialize the platform-specific components (I2C, etc.)
 * Must be called before using any VL53L4CD functions.
 */
